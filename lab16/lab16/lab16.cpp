...
void main()//главная функция
{
	...
	cout << "Вывод минимальных элементов каждой строки:" << endl;
	for (int i = 0; i < amm_of_rows; i++) {//цикл , исаользующий функцию для вычисления мин элемента для вывода минимального элемента каждой строки
		cout << "Минимальный элемент строки номер " << i + 1 << ": " << MinimalElementOfARow(matrix[i], amm_of_colomns) << endl;
	}
	MatrixChange(matrix, amm_of_rows, amm_of_colomns);//исользование функции для вывода преобразованной матрицы
